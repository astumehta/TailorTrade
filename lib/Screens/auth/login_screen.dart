...
import 'package:tailor_trade/Screens/auth/signup_screen.dart';
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                //testing buttons for now till we configure the auth process
                TextButton(
                    onPressed: () {
                ...
                TextButton(
                    ...
                    child: const Text('Aren\'t a user already ? SignUp now'))
              ],
            ),
          ),
        ),
